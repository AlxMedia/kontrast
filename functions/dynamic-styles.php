	...
	function alx_dynamic_css() {
		if ( get_theme_mod('dynamic-styles', 'on') == 'on' ) {
			...
			if ( get_theme_mod('sidebar-padding','30') != '30' ) {
				$styles .= '.sidebar .widget { padding-left: '.get_theme_mod('sidebar-padding').'px; padding-right: '.get_theme_mod('sidebar-padding').'px; padding-top: '.get_theme_mod('sidebar-padding').'px; }'."\n";
			}
			// primary color
...
.jp-play-bar,
.jp-volume-bar-value { background-color: '.get_theme_mod('color-1').'; }
...
@media only screen and (min-width: 720px) {
	...
	#nav-header .nav li.current-post-parent > a { color: '.get_theme_mod('color-1').'; }
}
...
.wp-pagenavi span.current { border-bottom-color: '.get_theme_mod('color-1').'!important; }				
			...
			if ( get_theme_mod('color-bubble','#dd5827') != '#dd5827' ) {
				$styles .= '
.post-comments { background-color: '.get_theme_mod('color-bubble').'; }
.post-comments span:before { border-right-color: '.get_theme_mod('color-bubble').'; border-top-color: '.get_theme_mod('color-bubble').'; }				
				'."\n";
			}			
			// footer menu color

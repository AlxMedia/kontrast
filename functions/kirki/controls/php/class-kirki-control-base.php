...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected' => esc_attr__( 'No File Selected', 'kontrast' ),
				'remove'         => esc_attr__( 'Remove', 'kontrast' ),
				'default'        => esc_attr__( 'Default', 'kontrast' ),
				'selectFile'     => esc_attr__( 'Select File', 'kontrast' ),
				'standardFonts'  => esc_attr__( 'Standard Fonts', 'kontrast' ),
				'googleFonts'    => esc_attr__( 'Google Fonts', 'kontrast' ),
			)
		);

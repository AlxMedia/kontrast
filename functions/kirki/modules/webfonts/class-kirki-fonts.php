...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'kontrast' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'kontrast' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'kontrast' ),
			'200'       => esc_attr__( 'Light 200', 'kontrast' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'kontrast' ),
			'300'       => esc_attr__( 'Book 300', 'kontrast' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'kontrast' ),
			'400'       => esc_attr__( 'Normal 400', 'kontrast' ),
			'regular'   => esc_attr__( 'Normal 400', 'kontrast' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'kontrast' ),
			'500'       => esc_attr__( 'Medium 500', 'kontrast' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'kontrast' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'kontrast' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'kontrast' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'kontrast' ),
			'700'       => esc_attr__( 'Bold 700', 'kontrast' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'kontrast' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'kontrast' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'kontrast' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'kontrast' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'kontrast' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'kontrast' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'kontrast' ),
		);
	}

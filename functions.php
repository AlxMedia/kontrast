...
/*  Page title
/* ------------------------------------ */
if ( ! function_exists( 'kontrast_page_title' ) ) {

	function kontrast_page_title() {
		global $post;
...
/* ------------------------------------ */
if ( ! function_exists( 'kontrast_thumbnail_upscale' ) ) {

	function kontrast_thumbnail_upscale( $default, $orig_w, $orig_h, $new_w, $new_h, $crop ){
...
/*  IE js header
/* ------------------------------------ */
if ( ! function_exists( 'kontrast_ie_js_header' ) ) {

	function kontrast_ie_js_header () {
		echo '<!--[if lt IE 9]>'. "\n";
...
add_action( 'wp_head', 'kontrast_ie_js_header' );


/*  IE js footer
/* ------------------------------------ */
if ( ! function_exists( 'kontrast_ie_js_footer' ) ) {

	function kontrast_ie_js_footer () {
		echo '<!--[if lt IE 9]>'. "\n";
...
add_action( 'wp_footer', 'kontrast_ie_js_footer', 20 );	

...
?>
	...
	<div class="sidebar s1 <?php if ( get_theme_mod( 'light-sidebar', 'off' ) != 'on' ) echo 'dark'; ?>">
		
		<a class="sidebar-toggle" title="<?php esc_attr_e('Expand Sidebar','kontrast'); ?>"><i class="fa icon-sidebar-toggle"></i></a>
